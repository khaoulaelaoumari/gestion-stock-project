...
// Route::get('/', 'AuthenticationController@login_v2')->name('login');
 Route::get('/', 'AuthenticationController@login_v1')->name('auth-login-v1');
/* Route Dashboards */
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::post('EditUser', 'UserController@update')->name('edit-User');
  Route::post('DeleteUser', 'UserController@destroy')->name('delete-User');
  // Fournisseur

  Route::get('fournisseurs/list', 'FournisseurController@fournisseur_list')->name('app-fournisseur-list');
  Route::get('fournisseurs/add', 'FournisseurController@fournisseur_add')->name('app-fournisseur-add');
...
Route::group(['prefix' => 'auth'], function () {
  ...
  Route::post('login', 'AuthController@login')->name('custom-login-v1');
  ...
  Route::get('register', 'AuthenticationController@register_v1')->name('auth-register-v1');
  Route::post('register', 'AuthController@register')->name('register.custom');
