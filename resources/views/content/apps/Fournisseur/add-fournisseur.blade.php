  ...
  <div class="row invoice-add">
    ...
    <div class="col-xl-9 col-md-8 col-12">
      <div class="card invoice-preview-card">
          ...
          <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
            <div>
              {{-- <div class="logo-wrapper">
                ...
                <center><h3 class="text-primary">Ajout d'un fournisseur</h3></center>
              </div> --}}
              <center><h3 class="text-primary">Ajout d'un fournisseur</h3></center>
              <p class="card-text mb-25">Société Potentiel 2 Maroc</p>
              <p class="card-text mb-25">Assaka Agadir Maroc</p>
              <p class="card-text mb-0">+212 06666666666</p>
            </div>
            <div class="invoice-number-date mt-md-0 mt-2">
              <div class="d-flex align-items-center justify-content-md-end mb-1">
                <h4 class="invoice-title">Fournisseur ICE :</h4>
        ...
        <div class="card-body invoice-padding pt-0">
          <div class="row row-bill-to invoice-spacing">
            ...
            <div class="col-xl-12 mb-lg-1 col-bill-to pl-0">
              <h6 class="invoice-to-title">Nom de la société :</h6>
              <input type="text" class="form-control " />
            </div>
            {{-- Téléphone --}}
            <div class="col-xl-12 mb-lg-1 col-bill-to pl-0">
              <h6 class="invoice-to-title">Numéro Téléphone :</h6>
              <input type="text" class="form-control " />
            </div>
            {{-- Adresse --}}
            <div class="col-xl-12 mb-lg-1 col-bill-to pl-0">
        ...
        <center><h3 class="text-primary">Ajout des produits</h3></center>
                  ...
                  <div class="col-12 d-flex product-details-border position-relative pr-0">
                    <div class="row w-100 pr-lg-0 pr-1 py-2">
                      <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                        <p class="card-text col-title mb-md-50 mb-0">Référence Produit</p>
                        <input type="text" class="form-control " />
                        <textarea class="form-control mt-2" rows="2">Nom du produit</textarea>
                      </div>
                      <div class="col-lg-3 col-12 my-lg-0 my-2">
                        <p class="card-text col-title mb-md-2 mb-0">Prix D'achat</p>
                        <input type="text" class="form-control" value="24" placeholder="24" />
                      </div>
                      <div class="col-lg-2 col-12 my-lg-0 my-2">
                        <p class="card-text col-title mb-md-2 mb-0">Prix de vente</p>
...
It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!</textarea
    ...
    <div class="col-xl-3 col-md-4 col-12">
      <div class="card">
        <div class="card-body">
          <button class="btn btn-primary btn-block mb-75" >Ajouter Fournisseur</button>
          <button type="reset" class="btn btn-outline-primary btn-block">Annuler</button>
          <a href="{{url('app/invoice/preview')}}" class="btn btn-outline-primary btn-block mb-75">Créer une Facture</a>
        </div>
      </div>
      {{-- <div class="mt-2">
...
@section('page-script')
{{-- resources\views\content\apps\Fournisseur\app-fournisseur.js --}}
{{-- <script src="{{asset('js/scripts/pages/app-fournisseur.js')}}"></script> --}}
<script>
      date = new Date();
