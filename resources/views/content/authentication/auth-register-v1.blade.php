        ...
        <form class="auth-register-form mt-2" action="{{ route('register.custom') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="prenom"
              placeholder="johndoe"
              aria-describedby="register-prenom"
              tabindex="1"
              autofocus
            />
          </div>
          ...
          <div class="form-group">
            <label for="register-c" class="form-label">Password</label>
            ...
            <div class="input-group input-group-merge form-password-toggle">
              <input
                ...
                name="c_password"
                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                aria-describedby="register-cpassword"
                tabindex="3"
              />
              <div class="input-group-append">
                <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
          ...
          <div class="form-group">
            <label for="register-password" class="form-label">Téléphone</label>
